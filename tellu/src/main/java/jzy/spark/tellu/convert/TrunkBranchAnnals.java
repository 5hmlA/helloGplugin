...
public final class TrunkBranchAnnals {
     ...
     */
    static  {
        TRUNK_STR = Utills.getContext().getResources().getStringArray(R.array.trunk_string_array);
        BRANCH_STR = Utills.getContext().getResources().getStringArray(R.array.branch_string_array);
    }
